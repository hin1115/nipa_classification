...
class XDXD_SpaceNet4_UNetVGG16(nn.Module):
    def __init__(self, num_filters=64, pretrained=False):
        ...
        self.down4 = self.make_layer(_down_retain, 512)
        ...
        self.up_deconv4=self.make_layer(_up_deconv,[1024,256])
        self.conv_conc4 = nn.Conv2d(in_channels=512, out_channels=256, kernel_size=1, stride=1, padding=0)
        ...
        self.conv_conc3 = nn.Conv2d(in_channels=256, out_channels=128, kernel_size=1, stride=1, padding=0)
        ...
        self.up_deconv2=self.make_layer(_up_deconv,[256,64])
        self.conv_conc2 = nn.Conv2d(in_channels=128, out_channels=64, kernel_size=1, stride=1, padding=0)
        ...
        self.conv_conc1 = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=1, stride=1, padding=0)
