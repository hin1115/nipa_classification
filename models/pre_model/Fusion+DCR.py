...
class XDXD_SpaceNet4_UNetVGG16(nn.Module):
    def __init__(self, num_filters=32, pretrained=False):
        ...
        self.relu1 = nn.PReLU()
        self.down_1 = self.make_layer(_DCR_block_Encod, self.out_dim//2)
        self.down_2 = self.make_layer(_DCR_block_Encod, self.out_dim)
        self.down_3 = self.make_layer(_DCR_block_Encod, self.out_dim*2)
        self.down_4 = self.make_layer(_DCR_block_Encod, self.out_dim*4)
        ...
        self.up_1 =  self.make_layer(_DCR_block, self.out_dim*8)
        self.up_2 =  self.make_layer(_DCR_block, self.out_dim*4)
        self.up_3 =  self.make_layer(_DCR_block, self.out_dim*2)
        self.up_4 = self.make_layer(_DCR_block, self.out_dim)
